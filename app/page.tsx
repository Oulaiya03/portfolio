      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8 max-w-3xl animate-fade-in-up animation-delay-700">
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80 flex-shrink-0 animate-fade-in-up animation-delay-300">
            ...
            <Image
              ...
              width={320}
              height={320}
              className="relative rounded-full border-4 border-accent shadow-2xl shadow-accent/30 hover:scale-105 transition-transform duration-300 object-cover"
              priority
            />
          </div>
        </div>
